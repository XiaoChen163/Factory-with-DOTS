using UnityEngine;
    ...
    public sealed class TopDownPlayerController : MonoBehaviour
    {
        ...
        [SerializeField] private Vector2 yBounds = new Vector2(4f, 40f);
        ...
        private void MoveParallelToGrid()
        {
            ...
            nextPosition.y += verticalInput * verticalSpeed * Time.deltaTime;
            nextPosition.x = Mathf.Clamp(nextPosition.x, xBounds.x, xBounds.y);
            nextPosition.y = Mathf.Clamp(nextPosition.y, yBounds.x, yBounds.y);
